  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 sm:py-16 pb-20 sm:pb-0">
        <h1 className="text-3xl font-bold tracking-tight text-gray-950 mb-8">Privacy Policy</h1>
        <div className="prose prose-gray max-w-none space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">3. Profile Visibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">4. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">5. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">6. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">8. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-950 mt-8 mb-3">9. Changes to This Policy</h2>
            <p>

    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          <Link href="/admin/support" className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-white transition-colors">
          ...
          <Badge variant="outline" className="text-[10px] bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-800">Read Only</Badge>
        </div>
      </div>
              ...
              <div key={msg.id} className={`flex ${isEmployerMsg ? "justify-start" : "justify-end"}`}>
                <div
                  className={`max-w-[80%] rounded-2xl px-4 py-2.5 ${
                    isEmployerMsg
                      ? "bg-purple-50 border border-purple-100 text-gray-900 dark:text-white rounded-bl-md"
                      : "bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-800 text-gray-900 dark:text-white rounded-br-md"
                  }`}
                >
